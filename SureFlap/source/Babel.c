...
{
	/*
	dcp_work_packet_t	encrypt_descriptor;
	
	encrypt_descriptor.nextCmdAddress = 0;
	encrypt_descriptor.control0 = 0;

	//encrypt_descriptor.control0 = PAYLOAD_KEY | ENABLE_CIPHER | DECR_SEMAPHORE | KEY_WORD_SWAP | 0x77000000;  // Tag is 77.	
	(void)encrypt_descriptor;	// stop compiler warnings until this gets implemented.
	*/
	return false;
}
