...
static LED_BRIGHTNESS	led_current_brightness	= {0, 0, 0, 0};	// Starts off.
static LED_BRIGHTNESS	led_target_brightness	= {0, 0, 0, 0};	// Derived from Pattern, or driven directly.
