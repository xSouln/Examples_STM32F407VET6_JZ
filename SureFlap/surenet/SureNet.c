...
static uint8_t SecurityKeys[MAX_NUMBER_OF_DEVICES][SECURITY_KEY_SIZE] @ "ITCM";
static uint8_t SecretKeys[MAX_NUMBER_OF_DEVICES][CHACHA_MAX_KEY_SZ] @ "ITCM";
...
static RECEIVED_SEQUENCE_NUMBER received_sequence_numbers[RX_SEQ_BUFFER_SIZE] @ "DTCM";
