...
typedef __packed struct	// parameters used as part of DEVICE_RCVD_SEGS message
{
...
typedef __packed struct     // This would be more logically located in SureNet.h, however, it needs DEVICE_DATA_STATUS
...
typedef __packed struct	// used to send rcvd segs params into the application
{
	DEVICE_RCVD_SEGS_PARAMETERS rcvd_segs_params;
	uint64_t	device_mac;
