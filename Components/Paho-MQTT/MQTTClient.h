...
enum returnCode { MQTT_RESULT_BUFFER_OVERFLOW = -2, MQTT_RESULT_FAILURE = -1, MQTT_RESULT_SUCCESS = 0 };
...
extern void TimerInit(MQTTTimerT*);
extern char TimerIsExpired(MQTTTimerT*);
extern void TimerCountdownMS(MQTTTimerT*, unsigned int);
extern void TimerCountdown(MQTTTimerT*, unsigned int);
extern int TimerLeftMS(MQTTTimerT*);
...
typedef struct MQTTClient
{
    ...
    MQTTNetworkT* ipstack;
    MQTTTimerT last_sent, last_received;
 ...
 * @param
 */
DLLExport void MQTTClientInit(MQTTClient* client, MQTTNetworkT* network, unsigned int command_timeout_ms,
